...
function NavBar(){
    return(
        ...
        <div style={{marginLeft:"0.5%",marginRight:"0.5%", backgroundColor:'#fff',color:'#07588a',zIndex:10,boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)'}}>
            <nav className="navbar navbar-expand-lg navbar-light p-0 m-0 " >
                <div className="container-fluid  ">
                  <div className="navbar-brand d-flex align-items-center" style={{color:'#07588a',fontSize:'30px', fontWeight:"600"}}>
                    ...
                    {/* <div style={{color:"#bc50fb", fontFamily:"sans-serif"}}> ResumeSnap. </div> */}
